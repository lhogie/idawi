...
*Idawi* is extensively described in this [working paper](https://hal.archives-ouvertes.fr/hal-03562184) and in the the following publications:
- [A Decentralized Web Service Infrastructure for the Interoperability of Applications in Multihop Dynamic Networks](https://hal.science/hal-04075895)  (CIoT'2023)
- [A Service-Oriented Middleware Enabling Decentralised Deployment in Mobile Multihop Networks](https://hal.science/hal-03886521v1) (FMCIoT'2022)
- [Idawi: a decentralized middleware for achieving the full potential of the IoT, the fog, and other difficult computing environments](https://hal.science/hal-03863333v1) (Middlewedge'2022)
