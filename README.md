*Idawi* ([paper](http://www.i3s.unice.fr/~hogie/idawi.pdf)) is a Java middleware for Research in distributing computing, HPC, IOT, Fog/edge computing and IA. It is developed at the
...
Briefly, *Idawi* enables distributed computations. To this purpose it comes with the following features:
