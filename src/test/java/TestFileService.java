...
public class TestFileService {
	...
	@Test
	public void pingViaSSH() throws CDLException, IOException, MessageException {
		...
		System.out.println(c1.lookupService(FileService.class).call(c2, FileService.class, "listFiles").collect()
				.throwAnyError().resultMessages().contents());

		c1.lookupService(FileService.class).call(c2, FileService.class, "uploadFileAsOneSingleMessage", "test",
		...
		System.out.println(new String((byte[]) c1.lookupService(FileService.class)
				.call(c2, FileService.class, "downloadFileAsOneSingleMessage", "test").collect().throwAnyError()
